"""
Cohere Interpreter Module

This module provides intelligent interpretation of email security scan results using Cohere's LLM API.
...
class CohereInterpreter:
    """
    A class that uses Cohere's LLM to provide intelligent interpretation of email security scan results.
    """
    
    def __init__(self):
        """Initialize the CohereInterpreter with API key."""
    ...
    def _get_api_key(self) -> Optional[str]:
        """Get Cohere API key from environment or Streamlit secrets."""
        api_key = None
    ...
    def interpret_results(self, 
        ...
        if not self.client:
            return {
                "tone_analysis": "Cohere API not available",
                "prompt_injection_interpretation": "Cohere API not available", 
                "url_analysis": "Cohere API not available"
            }
...
"""
    ...
    def _parse_interpretation_sections(self, text: str) -> Dict[str, str]:
        """Parse the Cohere response into separate sections."""
        sections = {}
    ...
    def is_available(self) -> bool:
        """Check if Cohere API is available and configured."""
